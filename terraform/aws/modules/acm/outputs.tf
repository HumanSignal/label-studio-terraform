output "acm_certificate_arn" {
  ...
  value       = element(concat(aws_acm_certificate_validation.acm_certificate_validation.*.certificate_arn, aws_acm_certificate.acm_certificate.*.arn, [""]), 0)
}
...
output "acm_certificate_validation_emails" {
  ...
  value       = flatten(aws_acm_certificate.acm_certificate.*.validation_emails)
}
